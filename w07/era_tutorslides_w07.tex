...
\begin{frame}[c, fragile]{}{}
  \begin{center}
    ...
    \begin{block}{Zitat der Woche}
      \vspace{0.5cm}
      \begin{quote}
        ``Am Ende braucht man seine Vollidioten für jedes Gebiet. \dots  es gibt andere Vollidioten für Elektrotechnik und so halten wir die Welt zusammen''
        \vspace{0.5cm}
    ...
    \end{block}
    \vspace{0.5cm}
    Quelle: \href{https://zulip.in.tum.de/#narrow/stream/1827-ERA---Memes/topic/Zitat.20der.20Woche/near/1715741}{Zulip - ERA Memes}
\end{center}
\end{frame}
